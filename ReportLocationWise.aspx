                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSearch" runat="server" Text="Search" 
                            ...
                            <asp:Label ID="lblDownloadPage" runat="server" Text=""></asp:Label>
                            <br />
                            <br />
                              <asp:Button ID="btnPrint" runat="server" Text="Generate Download Page for Location" 
                            onclick="btnPrint_Click1" />
                            <br />
                        
                            <asp:Button ID="btnPdfAdmin" runat="server" 
                            Text="Generate Download Page for Admin" onclick="btnPdfAdmin_Click" 
                            />
                        ...
                        <br />
                        <br />
                        <asp:Button ID="btnDownloadOFACFile" runat="server" 
                            Text="Download OFAC File" onclick="btnDownloadOFACFile_Click" 
                            />
<asp:Label ID="lblDownloadOFAC" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
            </table>
