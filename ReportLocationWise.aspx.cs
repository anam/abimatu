...
INSERT INTO [SessionTable]
     ...
     VALUES
        ...
        MSSQL.SQLExec(sql);
        lblDownloadPage.Text = "<a target='_blank' href='ReportLocationWisePrintAdmin.aspx?fromDate=" + txtFromDate.Text + @"&toDate=" + txtToDate.Text + @"'>Click here to go donwload page</a>";
    
    }
    protected void btnDownloadOFACFile_Click(object sender, EventArgs e)
    {
        string sql = @"Delete SessionTable ;
INSERT INTO [SessionTable]
           ([SessionName]
     ...
     VALUES
        ...
        lblDownloadOFAC.Text = "<a target='_blank' href='ReportLocationWisePrintAdminOFAC.aspx?fromDate=" + txtFromDate.Text + @"&toDate=" + txtToDate.Text + @"'>Download the OFAC File</a>";
...
INSERT INTO [SessionTable]
     ...
     VALUES
        ...
        MSSQL.SQLExec(sql);
        lblDownloadPage.Text = "<a target='_blank' href='ReportLocationWisePrintAdmin_Paid.aspx?fromDate=" + txtFromDate.Text + @"&toDate=" + txtToDate.Text + @"'>Click here to go donwload page</a>";
